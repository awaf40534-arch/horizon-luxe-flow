                  ...
                  <div className="flex gap-4 lg:gap-5 h-[18rem] lg:h-[16rem]">
                    ...
                    <div className="hidden lg:block relative w-40 h-full flex-shrink-0">
                      ...
                      <div className="relative h-full w-full overflow-hidden rounded-xl border border-white/15 shadow-lg shadow-black/30">
                        <img
                          src="/images/service-personnel-side.jpg"
                          alt="Anglais 100% pratique"
                          className="w-full h-full object-cover levitate"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative overflow-hidden rounded-2xl glass-premium p-6 lg:p-7 shadow-xl shadow-[rgba(0,0,0,0.15)] border border-[var(--gold)]/25">
                  <div className="flex gap-4 lg:gap-5 h-[18rem] lg:h-[16rem]">
                    ...
                    <div className="hidden lg:block relative w-40 h-full flex-shrink-0">
                      ...
                      <div className="relative h-full w-full overflow-hidden rounded-xl border border-white/15 shadow-lg shadow-black/30">
                        <img
                          src="/images/service-numerique-side.jpg"
                          alt="Initiation au numérique"
                          className="w-full h-full object-cover levitate"
                ...
                <div className="relative overflow-hidden rounded-2xl glass-premium p-6 lg:p-7 shadow-xl shadow-[rgba(0,0,0,0.15)] border border-[var(--gold)]/25">
                  <div className="flex gap-4 lg:gap-5 h-[18rem] lg:h-[16rem]">
                    ...
                    <div className="hidden lg:block relative w-48 h-full flex-shrink-0 pr-2">
                      ...
                      <div className="relative h-full w-full rounded-xl border border-white/15 shadow-lg shadow-black/30">
                        <img
                          src="/images/service-anglais-side.jpg"
                          alt="Développement personnel"
                          className="w-full h-full object-contain object-center levitate z-10"
                  ...
                  <div className="lg:hidden mt-3 relative h-32 -mx-6 -mb-6 px-2">
                    ...
                    <img
                      src="/images/service-anglais-side.jpg"
                      alt="Développement personnel"
                      className="relative w-full h-full object-contain object-center levitate z-20"
                      style={{ animationDelay: '0.4s' }}
                    />
                  </div>
                </div>
              ...
              <Reveal delay={100}>
                <div className="flex justify-center relative group">
                  ...
                  <div className="relative w-full max-w-xs">
                    ...
                    {/* Portrait Image */}
                    <div className="relative h-96 w-full overflow-hidden rounded-2xl border border-white/10 shadow-2xl shadow-black/30 overflow-visible">
                      <img
                    ...
                    {/* Decorative elements - Arms support */}
                    <div className="absolute -left-12 top-1/3 w-24 h-1 bg-gradient-to-r from-transparent via-gold/20 to-transparent rotate-[-20deg] rounded-full blur-md"></div>
                    <div className="absolute -right-12 top-1/3 w-24 h-1 bg-gradient-to-r from-transparent via-gold/20 to-transparent rotate-[20deg] rounded-full blur-md"></div>
                  </div>
                </div>
              </Reveal>
